...
export function render({ id }) {
    ...
    <div class="cv-page-container">
      ...
      <div class="cv-bid-room">
        <div>
          <div style="aspect-ratio:4/3;background:linear-gradient(135deg, ${item.color || '#333'} 0%, var(--color-gradient-end) 100%);border-radius:var(--radius-lg);margin-bottom:var(--space-6);display:flex;align-items:center;justify-content:center;">
            <span style="font-family:var(--font-display);font-size:var(--text-xl);color:rgba(255,255,255,0.12);font-style:italic;">${item.title}</span>
          </div>
